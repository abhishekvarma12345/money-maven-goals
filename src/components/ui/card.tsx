...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "dark:border-gray-800 dark:bg-gray-900/95 dark:text-gray-100",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-2xl font-semibold leading-none tracking-tight break-words whitespace-normal",
      "text-card-foreground dark:text-gray-100",
      className
    )}
    {...props}
  />
